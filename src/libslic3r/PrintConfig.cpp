...
*/
    ...
    def->tooltip = L("Address a specific running OrcaSlicer instance by its pid or instance id instead of whichever instance owns this executable's single-instance lock. See also --target-file. Supported on macOS and Windows.");
    ...
    def->tooltip = L("Address whichever running OrcaSlicer instance currently has this file loaded, instead of whichever instance owns this executable's single-instance lock. Requires that instance to have "
                     "\"Allow targeting this instance by its loaded file name\" enabled in Preferences. Supported on macOS and Windows.");
